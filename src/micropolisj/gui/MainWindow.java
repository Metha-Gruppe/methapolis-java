...
//		engine.getSprites().add(new SpaceshipSprite(engine, 350, 500));
	...
	// TODO CUSTOM: toggle background music
	private void onSoundClicked() {
		doSounds = !doSounds;
		// sounds are now enabled => play background music
		if(doSounds) {
			backgroundMusic.play();
		}
		// sounds are now disabled => stop background music
		else {
			backgroundMusic.close();
		}
...
//		System.out.println(iconName);
	...
	@Override
	public void onEnd() {
		EndGamePane endGamePane = new EndGamePane(this);
