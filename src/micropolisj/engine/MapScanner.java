 ...
 * tile will get activated, and this class contains the activation code.
 */
class MapScanner extends TileBehavior {
	public static enum B {
		RESIDENTIAL, HOSPITAL_CHURCH, COMMERCIAL, INDUSTRIAL, COAL, NUCLEAR, FIRESTATION, POLICESTATION, STADIUM_EMPTY, STADIUM_FULL, AIRPORT, SEAPORT;
	}
	...
	boolean setZonePower() {
		...
		boolean newPower = (tile == NUCLEAR || tile == POWERPLANT || city.hasPower(xpos, ypos));
	...
	/**
	 * Place a 3x3 zone on to the map, centered on the current location. Note:
	 * nothing is done if part of this zone is off the edge of the map or is
	 * being flooded or radioactive.
	 * 
	 * @param base
	 *            The "zone" tile value for this zone.
	 ...
	 * Only tiles that are not rubble, radioactive, flooded, or on fire will be
	 * regenerated.
	 * 
	 * @param zoneCenter
	 ...
	 * 
	 * @return integer; positive number indicates good place for house to go;
	 *         zero or a negative number indicates a bad place.
	 */
	 ...
	 * 
	 * @return an integer between -3000 and 3000 Same meaning as
	 *         evalResidential.
	 */
	 ...
	 * 
	 * @return an integer between -3000 and 3000. The higher the number, the
	 *         more likely the zone is to GROW; the lower the number, the more
	 *         likely the zone is to SHRINK.
	 */
	...
	/**
	 * Gets the land-value class (0-3) for the current residential or commercial
	 * zone location.
	 * 
	 * @return integer from 0 to 3, 0 is the lowest-valued zone, and 3 is the
	 *         highest-valued zone.
	 */
	int getCRValue() {
		// get land value: living quality depending on the current surroundings
	...
	/**
	 * Record a zone's population change to the rate-of-growth map. An
	 * adjustment of +/- 1 corresponds to one little house. An adjustment of +/-
	 * 8 corresponds to a full-size zone.
	 * 
	 * @param amount
	 *            the positive or negative adjustment to record.
	 */
	...
	/**
	 * @return 1 if traffic "passed", 0 if traffic "failed", -1 if no roads
	 *         found
	 */
