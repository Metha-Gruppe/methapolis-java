...
class TerrainBehavior extends TileBehavior {
	...
	static enum B {
		FIRE, FLOOD, RADIOACTIVE, ROAD, RAIL, EXPLOSION;
	}
	...
	static int[] TRAFFIC_DENSITY_TAB = {
			ROADBASE, LTRFBASE, HTRFBASE
	};
	...
	/**
	 * Called when the current tile is a road bridge over water. Handles the
	 * draw bridge. For the draw bridge to appear, there must be a boat on the
	 * water, the boat must be within a certain distance of the bridge, it must
	 * be where the map generator placed 'channel' tiles (these are tiles that
	 * look just like regular river tiles but have a different numeric value),
	 * and you must be a little lucky.
	 * 
	...
	boolean doBridge() {
		...
		final char HBRTAB[] = {
				HBRDG1, HBRDG3, HBRDG0, RIVER, BRWH, RIVER, HBRDG2
		};
		final char HBRTAB2[] = {
				RIVER, RIVER, HBRIDGE, HBRIDGE, HBRIDGE, HBRIDGE, HBRIDGE
		};
		...
		final char VBRTAB[] = {
				VBRDG0, VBRDG1, RIVER, BRWV, RIVER, VBRDG2, VBRDG3
		};
		final char VBRTAB2[] = {
				VBRIDGE, RIVER, VBRIDGE, VBRIDGE, VBRIDGE, VBRIDGE, RIVER
		};
